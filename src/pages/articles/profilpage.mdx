...
import capt01 from './Capt_20221125_035048.png'
import capt02 from './Capt_20221125_035206.png'


export const meta = {
  author: 'Ste',
  date: '2022-12-12',
  title: 'How to make a Beautiful Pro Business Profile Picture',
  description:
